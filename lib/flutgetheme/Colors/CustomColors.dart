...
class CustomColors {
  /// App / Client Specific
  static Color primaryColorLight = const Color(0xff1f72ee);
  static Color primaryColorDark = const Color(0xff1658bb);
  static Color secondaryColorLight = const Color(0xffccac5a);
  static Color secondaryColorDark = const Color(0xffb29344);
  /// Theme Specific
  ...
  static Color splashColorLight = const Color(0xfffcf12d);
  static Color splashColorDark = const Color(0xfff3eb50);
  static Color hintColorLight = const Color(0xff84bd63);
  static Color hintColorDark = const Color(0xff77b652);
